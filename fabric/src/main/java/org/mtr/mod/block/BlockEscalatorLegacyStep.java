...
public class BlockEscalatorLegacyStep extends BlockEscalatorLegacy {
	...
	public BlockState getStateForNeighborUpdate2(BlockState state, Direction direction, BlockState neighborState, WorldAccess world, BlockPos pos, BlockPos neighborPos) {
		if (direction == Direction.UP && !(world.getBlockState(pos.up()).getBlock().data instanceof BlockEscalatorLegacySide)) {
	...
	public ActionResult onUse2(BlockState state, World world, BlockPos pos, PlayerEntity player, Hand hand, BlockHitResult hit) {
		return IBlock.checkHoldingBrush(world, player, () -> {
			...
			if (isStep(world, sidePos)) {
				final BlockEscalatorLegacyStep block = (BlockEscalatorLegacyStep) world.getBlockState(sidePos).getBlock().data;
	...
	private boolean isStep(World world, BlockPos pos) {
		...
		return block.data instanceof BlockEscalatorLegacyStep;
	}
}

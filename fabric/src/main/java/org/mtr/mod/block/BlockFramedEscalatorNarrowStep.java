...
public class BlockFramedEscalatorNarrowStep extends BlockFramedEscalatorNarrowBase {
    
    // getStateForNeighborUpdate2
    @Nonnull
    @Override
    public BlockState getStateForNeighborUpdate2(BlockState state, Direction direction, BlockState neighborState, WorldAccess world, BlockPos pos, BlockPos neighborPos) {
        if(direction == Direction.UP && !(world.getBlockState(pos.up()).getBlock().data instanceof BlockFramedEscalatorNarrowSide)){
    ...
    private boolean isStep(World world, BlockPos pos){
        ...
        return block.data instanceof BlockFramedEscalatorNarrowStep;
    }

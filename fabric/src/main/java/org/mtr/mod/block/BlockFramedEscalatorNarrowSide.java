...
public class BlockFramedEscalatorNarrowSide extends BlockFramedEscalatorNarrowBase {
    ...
    public BlockState getStateForNeighborUpdate2(BlockState state, Direction direction, BlockState neighborState, WorldAccess world, BlockPos pos, BlockPos neighborPos) {
        if(direction == Direction.DOWN && !(world.getBlockState(pos.down()).getBlock().data instanceof BlockFramedEscalatorNarrowStep)){
    ...
    public void onBreak2(World world, BlockPos pos, BlockState state, PlayerEntity player) {
        ...
        IBlock.onBreakCreative(world, player, blockBelow);

...
public abstract class BlockEscalatorWideBase extends BlockExtension implements IBlock, DirectionHelper {
    ...
    protected BlockEscalatorWideBase() {
    ...
    protected final EnumEscalatorWideOrientation getOrientation(BlockView world, BlockPos pos, BlockState state) {
        ...
        if (isAhead && isBehind) {
            ...
            return EnumEscalatorWideOrientation.TRANSITION_BOTTOM;
        } else if (isAhead && isBehindDown) {
            return EnumEscalatorWideOrientation.TRANSITION_TOP;
        } else if (isBehind) {

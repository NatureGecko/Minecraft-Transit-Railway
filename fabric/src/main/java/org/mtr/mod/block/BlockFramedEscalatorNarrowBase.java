...
public abstract class BlockFramedEscalatorNarrowBase extends BlockExtension implements IBlock, DirectionHelper {

    public static final EnumProperty<EnumFramedEscalatorNarrowHeading> HEADING = EnumProperty.of("heading", EnumFramedEscalatorNarrowHeading.class);
    public static final EnumProperty<EnumFramedEscalatorNarrowOrientation> ORIENTATION = EnumProperty.of("orientation", EnumFramedEscalatorNarrowOrientation.class);
    public static final EnumProperty<EnumFramedEscalatorNarrowSide> VARIANT = EnumProperty.of("variant", EnumFramedEscalatorNarrowSide.class);
    public static final EnumProperty<EnumFramedEscalatorNarrowHandrailColor> HANDRAIL_COLOR = EnumProperty.of("handrail_color", EnumFramedEscalatorNarrowHandrailColor.class);
    public static final EnumProperty<EnumFramedEscalatorNarrowStepVariant> STEP_VARIANT = EnumProperty.of("step_variant", EnumFramedEscalatorNarrowStepVariant.class);

    protected BlockFramedEscalatorNarrowBase() {
    ...
    public BlockState getStateForNeighborUpdate2(BlockState state, Direction direction, BlockState neighborState, WorldAccess world, BlockPos pos, BlockPos neighborPos) {
        if (IBlock.getStatePropertySafe(state, FACING) == direction && !neighborState.isOf(new Block(this))) {
            ...
            BlockState block = state.with(new Property<>(ORIENTATION.data), getOrientation(BlockView.cast(world), pos, state));
            return block;
        }
    }
    ...
    @Override
    public Item asItem2() {
        return Items.FRAMED_ESCALATOR_NARROW.get();
    }
    ...
    protected final EnumFramedEscalatorNarrowOrientation getOrientation(BlockView world, BlockPos pos, BlockState state) {
    ...
    // * EnumFramedEscalatorNarrowHandrailColor
    public enum EnumFramedEscalatorNarrowHandrailColor implements StringIdentifiable {
        BLACK("black"), WHITE("white"), ORANGE("orange"), MAGENTA("magenta"), LIGHT_BLUE("light_blue"), YELLOW("yellow"), LIME("lime"),
        PINK("pink"), GRAY("gray"), LIGHT_GRAY("light_gray"), CYAN("cyan"), PURPLE("purple"), BLUE("blue"),
        BROWN("brown"), GREEN("green"), RED("red") ;

        private final String name;

        EnumFramedEscalatorNarrowHandrailColor(String nameIn) {
            name = nameIn;
        }
    ...
    public enum EnumFramedEscalatorNarrowSide implements StringIdentifiable {
        FULL_METAL("full_metal"), GLASS("glass"), GLASS_METAL("glass_metal") ;

        private final String name;

        EnumFramedEscalatorNarrowSide(String nameIn) {
            name = nameIn;
        }
    ...
    public enum EnumFramedEscalatorNarrowStepVariant implements StringIdentifiable {
        GRAY_YELLOW("gray_yellow"), GRAY("gray"), BLACK_YELLOW("black_yellow"), VINTAGE("vintage");

        private final String name;

        EnumFramedEscalatorNarrowStepVariant(String nameIn) {
            name = nameIn;
        }

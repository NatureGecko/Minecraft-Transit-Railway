...
public class BlockEscalatorLegacySide extends BlockEscalatorLegacy {

	@Nonnull
	@Override
	public BlockState getStateForNeighborUpdate2(BlockState state, Direction direction, BlockState neighborState, WorldAccess world, BlockPos pos, BlockPos neighborPos) {
		if (direction == Direction.DOWN && !(world.getBlockState(pos.down()).getBlock().data instanceof BlockEscalatorLegacyStep)) {

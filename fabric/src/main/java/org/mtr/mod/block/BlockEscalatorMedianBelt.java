...
public abstract class BlockEscalatorMedianBelt extends BlockExtension implements IBlock, DirectionHelper {
    ...
    protected BlockEscalatorMedianBelt() {
    ...
    public BlockState getPlacementState2(ItemPlacementContext context) {
        ...
        final boolean allowPlacement = IBlock.isReplaceable(context, direction, 1);

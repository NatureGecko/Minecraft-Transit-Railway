...
import org.mtr.mod.block.BlockEscalatorWideBase;
import org.mtr.mod.block.BlockEscalatorWideSide;
import org.mtr.mod.block.IBlock;

import javax.annotation.Nonnull;

public class ItemEscalatorWideSide extends ItemExtension implements IBlock {

    private final Block variant;

    public ItemEscalatorWideSide(ItemSettings itemSettings, Block variant) {
        super(itemSettings);
    ...
    public ActionResult useOnBlock2(ItemUsageContext context) {
        ...
        final BlockState sideState = variant.getDefaultState().with(new Property<>(BlockEscalatorWideSide.FACING.data), playerFacing.data);
